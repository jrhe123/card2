...
public class GlobalSettings : MonoBehaviour
{
    ...
    // AreaPosition: enum (top / low)
    public Dictionary<AreaPosition, Player> Players =
        new Dictionary<AreaPosition, Player>();
    ...
    public bool CanControlThisPlayer(AreaPosition owner)
    {
        ...
        return Players[owner].PArea.AllowedToControlThisPlayer &&
            Players[owner].PArea.ControlsON &&
            PlayersTurn &&
            NotDrawingAnyCards;
    }
